...
for o in range(1,2):
    ...
    piece11=cv2.imread('C:\Users\Badrawy\Documents\Visual Studio 2015\Projects\PythonApplication3\PythonApplication3/11.jpg')
    ...
    ###############################################
    piece12=cv2.imread('C:\Users\Badrawy\Documents\Visual Studio 2015\Projects\PythonApplication3\PythonApplication3/12.jpg')
    ...
    ##############################################
    piece21=cv2.imread('C:\Users\Badrawy\Documents\Visual Studio 2015\Projects\PythonApplication3\PythonApplication3/21.jpg')
    ...
    ###############################################
    piece22=cv2.imread('C:\Users\Badrawy\Documents\Visual Studio 2015\Projects\PythonApplication3\PythonApplication3/22.jpg')
    ...
    #printing features as a vector of 42 feature
    x.tolist()
    outputFile = open('1.xlsx', 'w')
